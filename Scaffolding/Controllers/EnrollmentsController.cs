...
namespace Scaffolding.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(ScaffoldingContext context)
        {
            _context = context;
        }
        ...
        {
            var scaffoldingContext = _context.Enrollments.Include(e => e.EnCourse).Include(e => e.EnStudent);
            return View(await scaffoldingContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var enrollment = await _context.Enrollments
                .Include(e => e.EnCourse)
                .Include(e => e.EnStudent)
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CourseID"] = new SelectList(_context.Courses, "Title", "Title", enrollment.CourseID);
            ViewData["StudentID"] = new SelectList(_context.Students, "LastName", "LastName", enrollment.StudentID);
            return View(enrollment);
        }
